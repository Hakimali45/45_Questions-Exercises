...
function carDetails(manufacturer, modelName) {
    ...
    for (var _i = 2; _i < arguments.length; _i++) {
        additionalInformation[_i - 2] = arguments[_i];
    }
    var car = __assign({ manufacturer: manufacturer, modelName: modelName }, Object.fromEntries(additionalInformation));
    return car;
}
;
var myCarDetails = carDetails("Tesla", "Model X", ['color', 'Black'], ['year', 2015]);
