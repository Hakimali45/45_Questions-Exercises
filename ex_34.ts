...
let myPizza = ["Afghani Pizza", "Pepperoni Pizza", "Fajita Pizza"];
...
console.log(`I really like to eat Pizzas.Pizza is one of my favorite foods because it's so versatile and customizable.`);